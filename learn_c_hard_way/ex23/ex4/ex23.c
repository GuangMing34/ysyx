...
int main(int argc, char *argv[])
{
    ...
    printf("normal_copy: Elapsed time: %.3f ms, %.3f us\n", elapsed_ms, elapsed_us);
    ...
    printf("duffs_device: Elapsed time: %.3f ms, %.3f us\n", elapsed_ms, elapsed_us);
    ...
    printf("zeds_device: Elapsed time: %.3f ms, %.3f us\n", elapsed_ms, elapsed_us);
